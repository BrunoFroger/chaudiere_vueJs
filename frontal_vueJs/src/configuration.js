        ...
        <table>\
          ...
          <tbody>\
              <tr>\
                ...
                <td>\
                  {{this.$parent.formatTemperature(configuration.consigne)}}<br>\
                  <input id="consigne" name="consigne" v-model="configuration.consigne" @keyup.enter="updateConsigne()"/>\
                </td>\
              </tr>\
              <tr>\
    ...
    methods: {
      loadEnvironnements() {
        ...
        fetch(requete).then(r => r.json()).then(response => {
          ...
          //console.log("environnements : " + this.updateDateTimeenvironnements);
        });
      },
      updateConsigne() {
        let requete = this.$parent.httpServer + "/updateConsigne?consigne=" + this.configuration.consigne
